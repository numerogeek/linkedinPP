...
final class PictureController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, UploaderHelper $uploaderHelper): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if($uploadedFile) {
                $destinationFilename= $uploaderHelper->uploadImage($uploadedFile);
                $picture->setImageFilename($destinationFilename);
            }
    ...
    public function edit(Request $request, Picture $picture, EntityManagerInterface $entityManager, UploaderHelper $uploaderHelper): Response
    {
        $form = $this->createForm(PictureType::class, $picture);
        $form->handleRequest($request);
